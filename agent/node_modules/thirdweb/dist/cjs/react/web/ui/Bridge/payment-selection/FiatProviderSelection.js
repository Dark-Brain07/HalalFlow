...
function FiatProviderSelection({ onProviderSelected, client, toChainId, toTokenAddress, toAddress, toAmount, currency, country, }) {
    ...
    if (quoteQueries.every((q) => q.isError)) {
        return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { center: "both", flex: "column", style: { minHeight: "200px", flexGrow: 1 }, children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "secondaryText", size: "sm", children: "No quotes available" }) }));
    }
    ...
    return ((0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "column", gap: "xs", style: {
            ...
            return ((0, jsx_runtime_1.jsx)(buttons_js_1.Button, { fullWidth: true, onClick: () => onProviderSelected(provider.id), style: {
                    borderRadius: index_js_1.radius.lg,
                    textAlign: "left",
                    padding: `${index_js_1.spacing.md}`,
                }, variant: "secondary", children: (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "row", gap: "sm", style: { alignItems: "center", width: "100%" }, children: [(0, jsx_runtime_1.jsx)(Img_js_1.Img, { alt: provider.name, client: client, height: index_js_1.iconSize.lg, src: provider.iconUri, width: index_js_1.iconSize.lg, style: {
                                borderRadius: index_js_1.radius.full,
                            } }), (0, jsx_runtime_1.jsx)(basic_js_1.Container, { flex: "column", gap: "3xs", style: { flex: 1 }, children: (0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", size: "md", weight: 500, children: provider.name }) }), (0, jsx_runtime_1.jsxs)(basic_js_1.Container, { flex: "column", gap: "3xs", style: { alignItems: "flex-end" }, children: [(0, jsx_runtime_1.jsx)(text_js_1.Text, { color: "primaryText", size: "sm", style: { fontWeight: 500 }, children: (0, formatTokenBalance_js_1.formatCurrencyAmount)(currency || "USD", quote.currencyAmount) }), (0, jsx_runtime_1.jsxs)(text_js_1.Text, { color: "secondaryText", size: "xs", children: [(0, formatNumber_js_1.formatNumber)(Number((0, units_js_1.toTokens)(quote.destinationAmount, quote.destinationToken.decimals)), 4), " ", quote.destinationToken.symbol] })] })] }) }, provider.id));
        })) : ((0, jsx_runtime_1.jsxs)(basic_js_1.Container, { center: "both", flex: "column", style: { flexGrow: 1, paddingBottom: index_js_1.spacing.lg }, px: "md", children: [(0, jsx_runtime_1.jsx)(Spinner_js_1.Spinner, { color: "secondaryText", size: "xl" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "lg" }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { center: true, color: "primaryText", size: "lg", weight: 600, trackingTight: true, children: "Searching Providers" }), (0, jsx_runtime_1.jsx)(Spacer_js_1.Spacer, { y: "xs" }), (0, jsx_runtime_1.jsx)(text_js_1.Text, { center: true, color: "secondaryText", size: "sm", multiline: true, style: {
                        textWrap: "pretty",
